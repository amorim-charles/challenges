...
public class TreeSetTest {
    public static void main(String[] args) {
        ...
        /*
         * Interface Set
         * TreeSet não permite referências duplicadas, organiza a lista por ordem natural ou por comparador fornecido
        */

        //Iinicializando com List.of ou Arrays.of
        Set<Lesson> lessonSet = new TreeSet<>(Set.of(lesson1, lesson2));
