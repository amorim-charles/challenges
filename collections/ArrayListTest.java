...
public class ArrayListTest {
    public static void main(String[] args) {
        ...
        /*
        * Interface List
        * ArrayList permite referências duplicadas e garante a ordem de inserção na lista.
        * É mais eficiente que LinkedList para get, mas perde em add e remove.
        */

        //Iinicializando com List.of ou Arrays.of
        List<Lesson> lessonList = new ArrayList<>(List.of(lesson1, lesson2));

        //Adicionando mais referências
        lessonList.add(lesson3);
        lessonList.add(lesson4);

        //adicionando referências duplicadas
        lessonList.add(lesson4);
